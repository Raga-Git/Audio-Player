!function(t){
    function i(i,a){
        ...
        this.currentElapsedTime=void 0,
        this.timer=void 0,
        this.init()
    }
    var a="jAudio",
    ...
    i.prototype={
        init:function(){
            ...
            t.events(),
            t.debug(),
            t.domAudio.volume=.05
        },
        play:function(t){
            var i=this;
            i.domAudio.play(),
            "play"!==i.currentState&&(clearInterval(i.timer),
            i.timer=setInterval(i.run.bind(i),50),
            i.currentState="play",
            t.data("action","pause"),
            t.removeClass("jAudio--control-play"),
            t.addClass("jAudio--control-pause"),
        ...
        pause:function(t){
            ...
            i.currentState="pause",
            t.data("action","play"),
            t.removeClass("jAudio--control-pause"),
            t.addClass("jAudio--control-play"),
            t.toggleClass("active")
        },
        stop:function(){
            var t=this;
            t.domAudio.pause(),
            t.domAudio.currentTime=0,
            t.animateProgressBarPosition(),
        ...
        prev:function(){
            var t,i=this;
            t=0===i.currentTrack?i.settings.playlist.length-1:i.currentTrack-1,
            i.changeTrack(t)
        },
        next:function(){
            var t,i=this;
            t=i.currentTrack===i.settings.playlist.length-1?0:i.currentTrack+1,
            i.changeTrack(t)
        },
        ...
        changeTrack:function(t){
            var i=this;
            i.currentTrack=t,
            i.domAudio.src=i.settings.playlist[t].file,
            ("play"===i.currentState||i.settings.autoPlay)&&i.play(),
            i.highlightTrack(),
            i.updateThumb(),
            i.renderDetails()
        },
        events:function(){
            ...
            i.$domProgressBar.on("click",function(t){
                i.updateProgressBar(t),
                i.updateElapsedTime()
            }),
            t(i.domAudio).on("loadedmetadata",function(){
                i.animateProgressBarPosition.call(i),
                i.updateElapsedTime.call(i),
                i.updateTotalTime.call(i)
            })
        },
        getAudioSeconds:function(t){
            var i=this,
                t=t%60;
            return t=i.addZero(Math.floor(t),2),
            t=60>t?t:"00"
        },
        ...
        highlightTrack:function(){
            var t=this,
                ...
                a="active";
            i.removeClass(a),
            i.eq(t.currentTrack).addClass(a)
        },
        ...
        renderPlaylist:function(){
            ...
            t.each(i.settings.playlist,function(t,i){
                ...
                i.trackAlbum;
                trackDuration="00:00",
                a+="<div class='jAudio--playlist-item' data-track='"+e+"'>",
                a+="<div class='jAudio--playlist-thumb'><img src='"+r+"'></div>",
                a+="<div class='jAudio--playlist-meta'>",
                a+="<p class='jAudio--playlist-meta-track-name'>"+o+"</p>",
                a+="<p class='jAudio--playlist-meta-track-artist'>"+s+"</p>",
                a+="</div>",
                a+="</div>"
            }),
        ...
        updateProgressBar:function(t){
            var i,a,e,r=this;
            t.offsetX&&(i=t.offsetX),
            void 0===i&&t.layerX&&(i=t.layerX),
            a=i/r.$domProgressBar.width(),
            e=r.domAudio.duration*a,
            r.domAudio.currentTime=e,
            r.animateProgressBarPosition()
        },
